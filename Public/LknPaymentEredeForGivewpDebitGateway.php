    ...
    final public static function debit_card_form($form_id, $args) {
        ...
        <fieldset id="give_dc_fields" class="give-do-validate">
            ...
            <div id="give-card-number-wrap"
                ...
                <input type="tel" autocomplete="off" name="lkn_erede_debit_3ds_card_number"
            ...
            <div id="give-card-expiration-wrap"
                ...
                <input type="tel" autocomplete="off" name="lkn_erede_debit_3ds_card_expiry"
            ...
            <div id="give-card-name-wrap" class="form-row form-row-two-thirds form-row-responsive">
                ...
                <input type="text" autocomplete="off"
                    ...
                    name="lkn_erede_debit_3ds_card_name" class="card-name give-input required"
            ...
            <div id="give-card-cvc-wrap"
                ...
                <input type="tel" size="4" maxlength="4" autocomplete="off" name="lkn_erede_debit_3ds_card_cvc"
